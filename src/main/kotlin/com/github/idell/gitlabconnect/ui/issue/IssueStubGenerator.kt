...
object IssueStubGenerator : Runnable, IssueGenerator {
    ...
    override fun generate(): MutableList<Issue> =
        mutableListOf(Issue("Ut lobortis elit non diam dictum efficitur sed nec dolor. Phasellus eros ligula, aliquam vitae.",
                            "http://www.example.com/agreement/attack.html",
                            listOf("great vengeance", "darkness"), "* add smoke test and e2e tests execution also into spinnaker deploy pipeline\n" +
