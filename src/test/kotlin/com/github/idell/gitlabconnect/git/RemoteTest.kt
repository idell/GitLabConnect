...
internal class RemoteTest {
    ...
    internal fun `given a valid ssh git remote, retrieve namespace with project`() {
        val gitRemote = Remote("origin", "git@gitlab.example.com:namespace/project.git")
    ...
    internal fun `given a valid ssh git remote without suffix, retrieve namespace with project`() {
        val gitRemote = Remote("origin", "git@gitlab.example.com:namespace/project")
    ...
    internal fun `given a valid ssh git remote, retrieve another namespace with project`() {
        val gitRemote = Remote("origin", "git@gitlab.example.com:another/project.git")
    ...
    internal fun `given a valid http remote, retrieve namespace and project`() {
        val gitRemote = Remote("origin", "https://example.lastminute.com/namespace/project.git")
    ...
    internal fun `given a valid http remote without suffix, retrieve namespace and project`() {
        val gitRemote = Remote("origin", "https://example.lastminute.com/namespace/project")
    ...
    internal fun `given a valid http remote, retrieve another namespace and project`() {
        val gitRemote = Remote("origin", "https://example.lastminute.com/another/project.git")

        assertEquals("another/project", gitRemote.getRepositoryWithNamespace())
    }

    @Test
    internal fun `given a valid http remote, retrieve another namespace with subgroup and project`() {
        val gitRemote = Remote("origin", "https://example.lastminute.com/subgroup/another/project.git")

        assertEquals("subgroup/another/project", gitRemote.getRepositoryWithNamespace())
    }

    @Test
    internal fun `check if an address is a valid git repository`() {
        assertThrows(GitlabConnectException::class.java) { Remote("origin", "$$$$$") }
    }
}
